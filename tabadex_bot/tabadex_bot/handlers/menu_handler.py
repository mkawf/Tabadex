...
from .admin_handler import show_admin_panel
from .exchange_handler import start_exchange_conv # <<<--- اصلاح شده
...
async def main_menu_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == get_text("exchange_button", lang):
        await start_exchange_conv(update, context) # <<<--- اصلاح شده
