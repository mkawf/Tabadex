...
# Handlers
admin_ticket_callback_handler = CallbackQueryHandler(show_admin_ticket_details, pattern="^admin_view_ticket_")
admin_ticket_close_handler = CallbackQueryHandler(admin_close_ticket, pattern="^admin_close_ticket_")
